...
Beispiel: Von einer Funktion \(f(x)=a\cdot e^{kx}+b\) ist bekannt, dass \(x\to-\infty\colon f(x)\to1\) gilt und dass das Schaubild durch den Ursprung und \(A(2\vert-4)\) verläuft.
\textcolor{loes}{
	\begin{enumerate}[label=\arabic*)]
		\item Aus \(x\to-\infty\colon f(x)\to1\) folgt, dass die Asymptote \(y=1\) ist und damit \(b=1\).
    ...
    \begin{minipage}{\textwidth}
		\adjustbox{valign=t}{\begin{minipage}{0.5\textwidth}
			\begin{enumerate}[label=\alph*)]
				...
				\item Von der Funktion \(f_7(x)=ae^{kx}+b\) ist das Verhalten bekannt: \(x\to-\infty\colon f_7(x)\to-1\) Zudem ist folgende Wertetabelle gegeben:
				...
				\begin{tabular}{c|cc}
					...
					\(f_7(x)\)&2&8
				\end{tabular}
				\item Von der Funktion \(f_8(x)=ae^{kx}+b\) ist das Verhalten bekannt: \(x\to-\infty\colon f_8(x)\to2\) Zudem ist folgende Wertetabelle gegeben:
				...
				\begin{tabular}{c|cc}
					...
					\(f_8(x)\)&0&1
				\end{tabular}
				\item Von der Funktion \(f_9(x)=ae^{kx}+b\) ist das Verhalten bekannt: \(x\to-\infty\colon f_9(x)\to-4\) Zudem ist folgende Wertetabelle gegeben:
