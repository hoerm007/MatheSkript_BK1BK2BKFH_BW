	...
	\begin{minipage}{\textwidth}
		\begin{minipage}{0.5\textwidth}
			\begin{enumerate}[label=\alph*)]
				...
				\(x\to\infty\colon f(x)\to\frac{7}{4}\)
	...
	\begin{minipage}{\textwidth}
		\begin{minipage}{0.5\textwidth}
			\begin{enumerate}[label=\alph*)]
				...
				\(x\to-\infty\colon f(x)\to\frac{3}{2}\)
		...
		\begin{minipage}{0.5\textwidth}
			\begin{enumerate}[label=\alph*)]
				...
				\(x\to\infty\colon f(x)\to\frac{5}{2}\)
