...
\begin{minipage}{\textwidth}
	\begin{minipage}{0.49\textwidth}
		\begin{minipage}[t]{0.95\textwidth}
			\includegraphics[width=.95\linewidth]{\eFkt/pics/versch1.png}
		\end{minipage}\\
	...
	\begin{minipage}{0.49\textwidth}
		\begin{minipage}[t]{0.95\textwidth}
			\includegraphics[width=.95\linewidth]{\eFkt/pics/versch2.png}
		\end{minipage}\\
...
\begin{minipage}{\textwidth}
	...
	\begin{minipage}{0.49\textwidth}
		\begin{minipage}[t]{0.95\textwidth}
			\includegraphics[width=.6\linewidth]{\eFkt/pics/verschBsp1.png}
		\end{minipage}\\
	\end{minipage}
\end{minipage}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
