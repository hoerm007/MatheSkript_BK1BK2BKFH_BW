...
\begin{minipage}{0.96\textwidth}
	\begin{tabular}{ccc}
		\begin{minipage}{0.33\textwidth}
			\includegraphics[width=.95\textwidth]{\quadFkt/pics/produkt1.png}
		\end{minipage}
		&
		\begin{minipage}{0.33\textwidth}
			\includegraphics[width=.95\textwidth]{\quadFkt/pics/produkt2.png}
		\end{minipage}
		&
		\begin{minipage}{0.33\textwidth}
			\includegraphics[width=.95\textwidth]{\quadFkt/pics/produkt3.png}
...
\begin{Answer}[ref=produktformNullstellenA2]\\
	\begin{minipage}{\textwidth}
		...
		\end{minipage}
	\end{minipage}\\ \ \\
	\includegraphics[width=.95\textwidth]{\quadFkt/pics/produktA2.png}
\end{Answer}