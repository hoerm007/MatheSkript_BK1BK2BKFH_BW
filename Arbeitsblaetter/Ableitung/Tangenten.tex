...
\begin{minipage}{\textwidth}
	...
	\adjustbox{valign=t, padding=2ex 0ex 0ex 0ex}{\begin{minipage}{0.5\textwidth-4ex}
            \iftoggle{qrcode}{
            \settototalheight{\imgheight}{\includegraphics[width=\linewidth]{\ableitung/pics/tangenteBsp.png}}%
            \setlength{\qrheight}{2.5cm}%
            \includegraphics[width=\linewidth]{\ableitung/pics/tangenteBsp.png}%
