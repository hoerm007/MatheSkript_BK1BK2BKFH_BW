...
\begin{minipage}{\textwidth}
	\adjustbox{valign=t, padding=0ex 0ex 2ex 0ex}{\begin{minipage}{0.5\textwidth-2ex}
		\centering\includegraphics[width=\textwidth]{\ableitung/pics/EinDrittelxMinus2QuadratMinus2.png}
	\end{minipage}}%
	\adjustbox{valign=t, padding=2ex 0ex 0ex 0ex}{\begin{minipage}{0.5\textwidth-2ex}
		Wert der Ableitung von \(f(x)=\frac{1}{3}x^2-\frac{4}{3}x-\frac{2}{3}\) grafisch bestimmt:

		An der Stelle \(x_0=1\): Die Tangente an der Stelle \(x=1\) hat eine Steigung von ca. \(-\frac{2}{3}\), also beträgt die Ableitung \(-\frac{2}{3}\).

		An der Stelle \(x_1=2\): \textcolor{loes}{Die Tangente an der Stelle \(x=2\) hat eine Steigung von ca. 0, also beträgt die Ableitung 2.}

		An der Stelle \(x_2=0\): \textcolor{loes}{Die Tangente an der Stelle \(x=0\) hat eine Steigung von \(-\frac{4}{3}\), also beträgt die Ableitung \(-\frac{4}{3}\).}

		An der Stelle \(x_0=4\): \textcolor{loes}{Die Tangente an der Stelle \(x=4\) hat eine Steigung von ca. \(\frac{4}{3}\), also beträgt die Ableitung \(\frac{4}{3}\).}
...
\begin{tcolorbox}
	...
	\textcolor{loestc}{\(f'(1)=-\frac{2}{3}\) (sprich f Strich von 1 gleich \(-\frac{2}{3}\)) bedeutet also, dass die Ableitung von f an der Stelle 1 den Wert \(-\frac{2}{3}\) hat. Würde man die Tangente an \(f\) an der Stelle 1 zeichnen, so hätte sie eine Steigung von \(-\frac{2}{3}\).}
