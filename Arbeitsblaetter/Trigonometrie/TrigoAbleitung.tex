...
Gegeben ist das Schaubild der Funktion \(f(x)=\sinn{x}\).\\
\begin{minipage}{\textwidth}
	\includegraphics[width=.95\linewidth]{\trigonometrie/pics/AbleitungSinus.png}
\end{minipage}
Skizziere das Schaubild der Ableitungsfunktion.\\
\begin{minipage}{\textwidth}
	\includegraphics[width=.95\linewidth]{\trigonometrie/pics/AbleitungEmpty.png}
\end{minipage}\vspace{\baselineskip}\\
Gegeben ist das Schaubild der Funktion \(f(x)=\coss{x}\).\\
\begin{minipage}{\textwidth}
	\includegraphics[width=.95\linewidth]{\trigonometrie/pics/AbleitungCosinus.png}
\end{minipage}
Skizziere das Schaubild der Ableitungsfunktion.\\
\begin{minipage}{\textwidth}
	\includegraphics[width=.95\linewidth]{\trigonometrie/pics/AbleitungEmpty.png}
