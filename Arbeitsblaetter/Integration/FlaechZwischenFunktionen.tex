...
\begin{minipage}{\textwidth}
	...
	\begin{minipage}{.4\textwidth}
		\includegraphics[width=.95\linewidth]{\integration/pics/FlaecheZwZweiFktBsp.png}
	\end{minipage}
\end{minipage}\vspace{\baselineskip}\\
\begin{minipage}{\textwidth}
	\begin{minipage}{.4\textwidth}
		\includegraphics[width=.95\linewidth]{\integration/pics/FlaecheZwZweiFktBsp2.png}
	\end{minipage}
	\begin{minipage}{.6\textwidth}\raggedright
