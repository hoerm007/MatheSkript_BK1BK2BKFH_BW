...
\begin{minipage}{\textwidth}
	\adjustbox{valign=t}{\begin{minipage}{.6\textwidth}\raggedright
		...
		\begin{align*}
			\int\limits_0^1 \frac{1}{4}x^2+1\td x&\approx\textcolor{loes}{1,2}\\
			\int\limits_1^3 \frac{1}{4}x^2+1\td x&\approx\textcolor{loes}{4,2}\\
			\int\limits_0^3 \frac{1}{4}x^2+1\td x&\approx\textcolor{loes}{5,4}
		\end{align*}
	\end{minipage}}%
...
\begin{minipage}{\textwidth}
	...
	\adjustbox{valign=t}{\begin{minipage}{.6\textwidth}\raggedright
		...
		\begin{align*}
			\int\limits_0^3 -\frac{2}{5}x^2+1\td x&\approx\textcolor{loes}{0,7}\\
			\int\limits_1^2 -\frac{2}{5}x^2+1\td x&\approx\textcolor{loes}{0}\\
			\int\limits_2^3 -\frac{2}{5}x^2+1\td x&\approx\textcolor{loes}{-1,4}
		\end{align*}
	\end{minipage}}%
\end{minipage}
\newpage
