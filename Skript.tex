...
\begin{document}
	...
	\newpage
	\input{./Arbeitsblaetter/LineareFunktionen/Lage.tex}%TODO Aufgaben erstellen
	\newpage
	...
	\newpage
	\input{./Arbeitsblaetter/GanzrationaleFunktionen/Aufgaben.tex}
	\newpage
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%	 \newpage
 	...
 	\newpage
 	\input{./Arbeitsblaetter/EFunktionen/Aufgaben.tex}%TODO ERSTELLEN
 	\newpage
 	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
