...
\begin{document}%TODO Schaubilder doppeln auf leer/lösung und per if-toggle einbinden
...
% 	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   \fakesection{Differentialrechnung}
 	...
 	\newpage
 	\input{./Arbeitsblaetter/Ableitung/GrafischesAbleitung.tex}%TODO Geogebra
 	\newpage
 	...
 	\newpage
 	\input{./Arbeitsblaetter/Ableitung/Faktorregel.tex}%TODO underfull boxes
 	\newpage
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   \fakesection{Integration}
 	...
 	\newpage
 	\input{./Arbeitsblaetter/Integration/FlaechZwischenFunktionen.tex}
 	\newpage
